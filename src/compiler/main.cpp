...
extern void command_compile( bool bHelp, const std::vector< std::string >& args );
        ...
        try
        {
            ...
            po::options_description commandOptions(" Commands");
            {
                ...
                commandOptions.add_options()
                    ...
                    ("compile", po::bool_switch( &bCmdCompile ), 
                        "Compile blueprint file" )
                        
                    ("clean",   po::bool_switch( &bCmdClean ),
                        "Remove any stashed compilation" )
                        
                    ("info",    po::bool_switch( &bCmdInfo ),
                        "Report blueprint info" )
                ;
            }
            ...
            switch( cmd )
            {                
                case eCmd_Compile         : command_compile( bShowHelp, commandArguments );  break;
